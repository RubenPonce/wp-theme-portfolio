<?php get_header(); ?>
    ...
    <h2 id="workExperienceToggle" class="we__title">Work Experience</h2>
    <div id="workExperienceSidebar" class="we__sidebar">
    <section class="work-experience">
        <span id="workExperienceClose" class="we__close">X</span>
